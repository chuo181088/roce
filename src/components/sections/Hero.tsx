          ...
          <div className="mx-auto max-w-7xl w-full px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 md:items-start">
              ...
              >
                ...
                {/* ✅ TARJETA DE ESTADÍSTICAS: ANCHO AJUSTADO PARA TEXTO EN 1 LÍNEA */}
                <div className="hidden md:block bg-white/90 backdrop-blur-sm rounded-xl border border-slate-200 p-5 shadow-sm max-w-2xl mb-8">
